...
#define TIA_RST_A_DEBUG_OUTPUT_Pin GPIO_PIN_4
#define TIA_RST_A_DEBUG_OUTPUT_GPIO_Port GPIOD
#define ADC1_DEBUG_OUTPUT_Pin GPIO_PIN_5
#define ADC1_DEBUG_OUTPUT_GPIO_Port GPIOD
#define TIMER2_DEBUG_OUTPUT_Pin GPIO_PIN_6
#define TIMER2_DEBUG_OUTPUT_GPIO_Port GPIOD
#define TIMER3_DEBUG_OUTPUT_Pin GPIO_PIN_7
#define TIMER3_DEBUG_OUTPUT_GPIO_Port GPIOD
